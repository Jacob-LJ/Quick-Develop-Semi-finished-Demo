 ...
 *
 *  @param frame            菜单frame
 *  @param targetController           将在在何控制器弹出
 ...
 *  @return 返回创建对象
 */
+ (JA_MenuView *)createMenuWithFrame:(CGRect)frame target:(UIViewController *)targetController dataArray:(NSArray *)dataArray itemsClickBlock:(void(^)(NSString *str, NSInteger tag))itemsClickBlock backViewTap:(void(^)())backViewTapBlock;
